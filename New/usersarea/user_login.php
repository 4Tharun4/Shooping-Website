...
<div class="container-fluid my-3">
        <h2 class="text-center">USERLOGIN</h2>
        ...
        <div class="col-lg-12 col-xl-6">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="mt-4 pt-2">
                    ...
                    <p class="small fw-bold mt-2 pt-1 mb-0">Dont't have a account? <a href="userregistration.php" class="text-danger">register</a></p>
                </div>
          </form>
</div>
</div>
